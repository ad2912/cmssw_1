...
pgun_pos="_5degree_500events_x2_y160_z400_digitiser_mipthreshold_granularity15_adjusted"
...
process.generator = cms.EDProducer("FlatRandomEGunProducer",
    ...
    PGunParameters = cms.PSet(
        ...
        MinEta = cms.double(3.1313), #cosmic muons [-1,1]
        MaxEta = cms.double(3.1313),
